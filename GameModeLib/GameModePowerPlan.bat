...
powercfg /SETACVALUEINDEX "!gm!" SUB_SLEEP RTCWAKE 2 2>nul
...
powercfg /SETACVALUEINDEX "!gm!" SUB_PROCESSOR SYSCOOLPOL 1 2>nul
...
powercfg /SETACVALUEINDEX "!gm!" SUB_VIDEO ADAPTBRIGHT 0 2>nul
...
::Advanced Color Quality Display
...
powercfg /SETDCVALUEINDEX "!gm!" SUB_SLEEP RTCWAKE 2 2>nul
...
powercfg /SETDCVALUEINDEX "!gm!" SUB_PROCESSOR SYSCOOLPOL 1 2>nul
...
powercfg /SETDCVALUEINDEX "!gm!" SUB_VIDEO ADAPTBRIGHT 0 2>nul
